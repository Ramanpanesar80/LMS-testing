...
public class createe {
    ...
    public void testEmailField() {
        WebElement emailField = driver.findElement(By.xpath
        	("/html/body/div/div/div/form/div[1]"));
        emailField.sendKeys("SimranKaur@gmail.com");
...
//    }
    ...
    public void testLogInButton() {
        ...
        assertNotNull("Log In button should be present", logInButton);
        assertTrue("Log In button should be displayed", logInButton.isDisplayed());
        assertEquals("Button text should be 'Sign In'", "Sign In", logInButton.getText());
    }
