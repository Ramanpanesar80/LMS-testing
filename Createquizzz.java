...
@Test
public void testLoginAndRedirectToAssignmentandquizz() {
    driver.get("http://localhost:3000/assignmentsandquizzes");
    ...
    try {
        ...
        wait.until(ExpectedConditions.urlContains("/assignmentsandquizzes"));
        String currentUrl = driver.getCurrentUrl();
        ...
        Assert.assertTrue("Login failed: Expected to be redirected to View Submitted Assignments page.",
                currentUrl.contains("/assignmentsandquizzes"));
...
@Test
public void testSelectAssignmnet() {
    driver.get("http://localhost:3000/assignmentsandquizzes");
    ...
    try {
        ...
        wait.until(ExpectedConditions.urlContains("/assignmentsandquizzes"));
        String currentUrl = driver.getCurrentUrl();
        Assert.assertTrue("Login failed: Expected to be redirected to View Submitted Assignments page.", currentUrl.contains("/assignmentsandquizzes"));
